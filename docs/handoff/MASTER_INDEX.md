...
Stable branch: `main`.
Verified stable merge: `b6ba6caf68ebf89c4944ea422bf768d448371f7e`.
Patch 015 source head: `2100df609f5c364ae4a688d563489f0ecb3a0c9e`.
Patch 015: `COMPLETE / MERGED` through PR #22.
Patch 013 runtime: `NOT RUN`.
Package 3B: `NOT_STARTED`.
Active patch: Patch 016 – Live Read-Only Favorite Light Status.
Active branch: `patch-016-live-read-only-favorite-light-status`.

No separate Patch 015 state-lock or finalization patch is required. Automatic
serial capture after flash is prohibited for Patch 016 runtime gates.
