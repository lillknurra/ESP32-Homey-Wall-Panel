...
- Patch022A is documentation-only and self-finalizing;
...
After Patch022A is merged and the merged `main` ref is verified, do not create
Patch022B or another patch solely to record Patch022A's own merge SHA.
