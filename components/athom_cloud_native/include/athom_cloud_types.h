...
typedef enum {
    ...
    ATHOM_ERR_TRANSPORT,
    ATHOM_ERR_RESPONSE,
    ATHOM_ERR_JSON_MALFORMED,
    ATHOM_ERR_JSON_DUPLICATE_KEY,
    ATHOM_ERR_VALUE_TOO_LARGE,
    ATHOM_ERR_TOKEN_RESPONSE,
    ATHOM_ERR_HOMEY_LIST_EMPTY,
    ATHOM_ERR_HOMEY_DUPLICATE,
    ATHOM_ERR_HOMEY_SELECTION_REQUIRED,
    ATHOM_ERR_HOMEY_SELECTION_STALE,
    ATHOM_ERR_SESSION_RESPONSE,
    ATHOM_ERR_HTTP_STATUS,
